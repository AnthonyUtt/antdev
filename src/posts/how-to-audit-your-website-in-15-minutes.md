...
- Does everything load within a few seconds?
...
- **Is your Google Business Profile showing?** If you have a physical location, your business info should appear on the right side of the results.
...
- **Look for missing images.** Scroll through your main pages and look for broken image icons or empty spaces where images should be.
- **Watch for redirect issues.** If clicking a link sends you somewhere unexpected, or if a page seems to hang and reload, you might have a redirect problem. I once worked with a client who had migrated their WordPress site and ended up with a handful of blog pages that all redirected to each other in an infinite loop. Nobody noticed for months because nobody was clicking those links.
...
- **Tap the navigation menu.** Is it easy to open and close? Can you tap the links without accidentally hitting the wrong one?
- **Read a full page of text.** Is the font large enough? Do you have to zoom in or scroll sideways?
- **Try to tap a button.** Are buttons big enough to tap easily with your thumb?
...
- **Is your contact information on every page?** Or do visitors have to hunt for it?

## What to Do With Your Findings

If you found issues, prioritize them:

1. **Fix immediately:** Broken contact forms, broken links, SSL issues
2. **Fix this week:** Mobile usability problems, missing contact info
3. **Fix when you can:** Outdated copyright, missing testimonials, slow load times

## Quick Reference Checklist

{% render 'partials/components/lead-magnet-form', formName: 'lead-website-audit', resourceSlug: 'website-audit-checklist', heading: 'Want a printable version?', description: 'Get the free PDF checklist to keep handy while you audit your site.' %}

- Site loads quickly on mobile
- Business purpose is immediately clear
- Call-to-action is visible without scrolling
- Site appears in Google search for your business name
