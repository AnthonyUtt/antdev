...
{% render 'partials/components/lead-magnet-form', formName: 'lead-data-entry-tracker', resourceSlug: 'data-entry-tracker', heading: 'Want a tracking template?', description: 'Download a free one-week tracking sheet to figure out what data entry is actually costing you.' %}
